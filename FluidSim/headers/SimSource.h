...
class SimSource
{
  public:
    ...
    void CreateGasSourceDynamic(Shape shape, float flowRate, float sourceTemp, float xCenter, float yCenter,
                                float radius, float flowVar, float tempVar);
    void CreateWindSource(float angle, float speed, float xCenter, float yCenter);
    void CreateWindSourceDynamic(float angle, float speed, float xCenter, float yCenter, float speedVar,
                                 float angleVar);
    void CreateHeatSource(Shape shape, float sourceTemp, float xCenter, float yCenter, float radius);
    void CreateHeatSourceDynamic(Shape shape, float sourceTemp, float xCenter, float yCenter, float radius,
                                 float tempVar);
    void CreateEnergySource(Shape shape, float flux, float referenceTemp, float referenceDensity, float xCenter,
                            float yCenter, float radius);
    void CreateEnergySourceDynamic(Shape shape, float flux, float referenceTemp, float referenceDensity, float xCenter,
                                   float yCenter, float radius, float fluxVar);
    void CreateWindBoundary(float speed);
    void CreateWindBoundaryDynamic(float speed, float speedVar);
  ...
  protected:
    ...
    {
      public:
        GasSource(int N, float lengthScale, Shape shape, float flowRate, float sourceTemp, float xCenter, float yCenter,
                  float radius);
    ...
    {
      public:
        WindSource(int N, float lengthScale, float angle, float speed, float xCenter, float yCenter);
    ...
    {
      public:
        HeatSource(int N, float lengthScale, Shape shape, float sourceTemp, float xCenter, float yCenter, float radius);
        float sourceTemp;
    };
